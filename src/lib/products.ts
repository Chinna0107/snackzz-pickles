export type Category = "hot-items" | "sweet-items" | "podis-powders" | "vadiyalu-papads";
...
export const products: Product[] = [
  ...
  // ─── VADIYALU & PAPADS (వడియాలు) ─────────────────────────────
  {
    id: "janthikala-vadiyalu",
    name: "జంతికాల వడియాలు",
    nameEnglish: "Janthikala Vadiyalu",
    category: "vadiyalu-papads",
    description: "Crispy string-shaped sun-dried wafers — fry in oil for the perfect crunchy side to any rice meal",
    price: 200,
    priceUnit: "250g",
    image: "/products/Vadiyalu_Papads/Jantikala_Vadiyalu.jpg",
    spiceLevel: "mild",
    shelfLife: "6 months",
    serves: "8-10 pieces",
    ingredients: ["Rice flour", "Urad dal", "Green chili", "Cumin", "Salt"],
    nutrition: { calories: "145 kcal", protein: "4g", carbs: "20g", fat: "5g", fiber: "1g" },
    tags: ["vegan", "gluten-free", "sun-dried", "daily-essential"],
  },
  {
    id: "flower-vadiyalu",
    name: "పూల వడియాలు",
    nameEnglish: "Flower Vadiyalu",
    category: "vadiyalu-papads",
    description: "Beautiful flower-shaped sun-dried wafers — they bloom into gorgeous crisps when fried, a visual delight",
    price: 220,
    priceUnit: "250g",
    image: "/products/Vadiyalu_Papads/Flower_Vadiyalu.jpg",
    badge: "Artisan",
    spiceLevel: "mild",
    shelfLife: "6 months",
    serves: "8-10 pieces",
    ingredients: ["Rice flour", "Urad dal", "Sesame seeds", "Cumin", "Salt"],
    nutrition: { calories: "150 kcal", protein: "5g", carbs: "19g", fat: "6g", fiber: "1g" },
    tags: ["vegan", "gluten-free", "sun-dried", "festive-special"],
  },
  {
    id: "rice-papads",
    name: "రైస్ పాపడ్లు",
    nameEnglish: "Rice Papads",
    category: "vadiyalu-papads",
    description: "Thin, crispy rice flour papads — fry or roast for a light, crunchy accompaniment to any meal",
    price: 180,
    priceUnit: "250g",
    ...
    shelfLife: "6 months",
    serves: "10-12 pieces",
    ingredients: ["Rice flour", "Tapioca", "Salt", "Cumin"],
    nutrition: { calories: "130 kcal", protein: "2g", carbs: "24g", fat: "3g", fiber: "0g" },
    tags: ["vegan", "gluten-free", "sun-dried", "daily-essential"],
  },
  {
    id: "rava-papads",
    name: "రవ్వ పాపడ్లు",
    nameEnglish: "Rava Papads",
    category: "vadiyalu-papads",
    description: "Semolina-based papads with a unique grainy texture — crispy, light and perfect with dal-rice",
    price: 190,
    priceUnit: "250g",
    image: "/products/Vadiyalu_Papads/Rava_Papads.jpg",
    spiceLevel: "none",
    shelfLife: "6 months",
    serves: "10-12 pieces",
    ingredients: ["Rava (Semolina)", "Rice flour", "Salt", "Cumin", "Black pepper"],
    nutrition: { calories: "140 kcal", protein: "3g", carbs: "22g", fat: "4g", fiber: "1g" },
    tags: ["vegan", "sun-dried", "daily-essential"],
  },
  {
    id: "saggu-biyyam-appadalu",
    name: "సగ్గు బియ్యం అప్పడాలు",
    nameEnglish: "Saggu Biyyam Appadalu",
    category: "vadiyalu-papads",
    description: "Tapioca pearl sun-dried crisps — light, airy and melt-in-mouth when fried, a Telangana summer staple",
    price: 200,
    priceUnit: "250g",
    image: "/products/Vadiyalu_Papads/Sago_Papads.jpg",
    popular: true,
    spiceLevel: "none",
    shelfLife: "6 months",
    serves: "8-10 pieces",
    ingredients: ["Tapioca pearls", "Green chili", "Cumin", "Salt", "Lemon"],
    nutrition: { calories: "135 kcal", protein: "1g", carbs: "26g", fat: "3g", fiber: "0g" },
    tags: ["vegan", "gluten-free", "sun-dried"],
  },
  {
    id: "gummadikaya-vadiyalu",
    name: "గుమ్మడికాయ వడియాలు",
    nameEnglish: "Gummadikaya Vadiyalu",
    category: "vadiyalu-papads",
    description: "Pumpkin-based sun-dried wafers — a unique Telangana speciality with subtle sweetness and crunch",
    price: 220,
    priceUnit: "250g",
    image: "/products/Vadiyalu_Papads/Pumpkin_Vadiyalu.jpg",
    badge: "Rare Find",
    spiceLevel: "mild",
    shelfLife: "6 months",
    serves: "8-10 pieces",
    ingredients: ["Pumpkin", "Rice flour", "Green chili", "Cumin", "Salt"],
    nutrition: { calories: "140 kcal", protein: "2g", carbs: "22g", fat: "5g", fiber: "2g" },
    tags: ["vegan", "gluten-free", "sun-dried"],
  },
  {
    id: "majjiga-mirchi",
